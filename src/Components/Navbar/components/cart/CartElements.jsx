...
export const CartElements = () => {
    ...
    const {cart, setCart, buyProducts, decrease} =useContext(dataContext)
    ...
    return cart.map((product) => {
        return(
                <li className="flex items-center gap-4 my-3" key={product.id}>
                    <img src={product.image} alt="product-image" className="h-16 w-16 rounded object-cover"/>
                    <div>
                        ...
                        <dl className="mt-0.5 space-y-px text-[10px] text-gray-600">
                            ...
                            <div>
                                ...
                                <dd className="inline">{product.stock}</dd>
                            </div>
                        </dl> 
                    </div>
                    <div className="flex flex-1 items-center justify-end gap-2">
                        <div className='flex flex-1 items-center justify-end gap-2 m-4'>
                            ...
                            <p className='counter__button' onClick={() => decrease(product)}>-</p>
                            <form>
                            ...
                            <p className='counter__button' onClick={() => buyProducts(product)} >+</p>
                        </div>
